...
%astd = nanstd(amatrix,[],1)/sqrt(length(amatrix(:,1))); % to get std shading
...
hold on;
lineOut = plot(F,amean, 'color', acolor,'linewidth',4); %% change color or linewidth to adjust mean line
    ax = gca
    ax.LineWidth = 4
